...
public class Validador {
    public static void validarCadena(String valor, String campo) throws DatosInvalidosException {
        if (valor == null || valor.trim().isEmpty()) throw new DatosInvalidosException("El campo " + campo + " no puede estar vacÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­o.");
    }
    ...
    public static void validarProductoDuplicado(String codigo, ProductoDAO dao) throws ProductoDuplicadoException {
        if (dao.buscarPorCodigo(codigo) != null) throw new ProductoDuplicadoException("El cÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³digo " + codigo + " ya existe.");
    }
